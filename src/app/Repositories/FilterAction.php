...
use Odama\Masks\Mask;
use Odama\Masks\MaskCollection;
use Odama\Magic\Arr;
use Odama\Masks\ExampleCollection;
...
trait FilterAction
{
     ...
     * @var string
     */
    protected $maskNamespace = 'Odama\Masks';
     ...
     * @param array $args
     * 
     * @return \Odama\Masks\MaskCollection
     */
     ...
     * @return \Odama\Masks\MaskCollectionExamples
     */
