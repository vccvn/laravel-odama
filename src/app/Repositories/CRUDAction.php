...
namespace Odama\Repositories\Repositories;

use Odama\Magic\Arr;
use Odama\Models\Model;
use Odama\Models\MongoModel;
use Odama\Models\SQLModel;
use Odama\Validators\ExampleValidator;
use Odama\Validators\Validator;
use ReflectionClass;
...
trait CRUDAction
{
     ...
     * @var string
     */
    protected $validatorNamespace = 'Odama\Validators';
    /**
    ...
    public function getValidator(Request $request, $validatorClass = null)
    {
        ...
        if ($this->validatorClass) {
            ...
            if (class_exists($this->validatorClass)) {
                ...
                $c = 'Odama\Validators\ExampleValidator';
            }
